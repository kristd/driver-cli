...
//            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pView.VIEW = findViewById(R.id.driverlist_progress);
        ...
        adapter = new DriverListRecyclerViewAdapter(driverList, this, intent.getBooleanExtra("isSwithActive", true), intent.getStringExtra("orderId"), closeHandler, showProgHandler, hideProgHandler);
